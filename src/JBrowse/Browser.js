        ...
        return declare(FeatureFiltererMixin, {
                        ...
                        dojo.hitch(this, function() {
                            array.forEach(arguments, function(pluginClass, i) {
                                ...
                                if (typeof pluginClass == 'string') {
                                    ...
                                    var args = dojo.mixin(
                                        dojo.clone(plugins[i]), { config: this.config[plugin.name] || {} });
                                    args.browser = this;
            ...
            initView: function() {
                ...
                return this._milestoneFunction('initView', function(deferred) {
                    ...
                    // kiran custom code start //
                    // make our own bar for readwear at the top
                    var readWearBar = dojo.create('div', { className: 'readWearBar', id: 'readwear' }, topPane);
                    this.readWearBarDiv = readWearBar;
                    // kiran custom code end //
                    ...
                    dojo.global.require([tl_class],
                        dojo.hitch(this, function(trackListClass) {
                            ...
                            this.subscribe('/jbrowse/v1/n/tracks/visibleChanged', dojo.hitch(this, function() {
                                this.cookie("tracks",
                                    this.view.visibleTrackNames().join(','), { expires: 60 });
                            }));
